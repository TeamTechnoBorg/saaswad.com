        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer-widget">
              ...
              <ul>
                <li>
                  <a class="hover1" href="./radiator.html"> Radiators</a>
                </li>
                <li>
                  <a class="hover1" href="./mradiator.html"
                    >Mechanically Bonded Radiators</a
                  >
                </li>
                <li>
                  <a class="hover1" href="./acooler.html"
                    >Radiator, Oil cooler and AfterCoolers Assembly</a
                  >
                </li>
                <li>
                  <a class="hover1" href="./tacooler.html"
                    >Turbo After Cooler</a
                  >
                </li>
